...
public class MOEADDSMSA extends AbstractMOEAD<MSASolution> {


    public MOEADDSMSA(Problem<MSASolution> problem,  //解决的问题类
...
//一个随机从邻居中随机选择，添加到方案中的过程。
    ...
    public String getDescription() {
        return "Version of MOEA/D-ds for solving MSA problems";
    }
}
